...
function detectorData = generateDetectorData(initialPosition, trueMap)
    ...
    leftDetectorValue = trueMap(round(initialPosition(1) * 24), trueMap(round(initialPosition(2) * 24)));
    rightDetectorValue = trueMap(round(initialPosition(1) * 24), trueMap(round(initialPosition(2) * 24)));
